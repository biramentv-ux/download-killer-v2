  ...
  <style>
    ...
    * { box-sizing: border-box; }
    body {
      ...
      background:
        radial-gradient(820px 420px at -8% -18%, rgba(0,247,168,0.25), transparent 62%),
        radial-gradient(860px 540px at 108% 8%, rgba(0,208,255,0.18), transparent 62%),
    ...
    .card {
      ...
      border-radius: 20px;
      padding: 28px;
      background: linear-gradient(155deg, rgba(7,16,38,0.88), rgba(7,15,34,0.84));
    ...
    .logo {
      ...
      place-items: center;
      border-radius: 14px;
      border: 1px solid rgba(0,247,168,0.55);
      background: linear-gradient(145deg, rgba(0,247,168,0.18), rgba(0,110,255,0.2));
      color: #d6ffe8;
      font-size: 25px;
    }
    .title {
    ...
    .loader {
      ...
      height: 4px;
      border-radius: 999px;
      background: rgba(95, 132, 207, 0.25);
      overflow: hidden;
    }
    .loader::before {
      content: "";
      ...
      width: 42%;
      height: 100%;
      background: linear-gradient(90deg, #00f7a8, #3de8ff);
...
<body>
  <div class="card">
    ...
    <div class="meta">Launching desktop sync shell...</div>
