(() => {
  ...
  const I18N = {
    bg: {
      ...
      profile_title: "unplayplay metadata профил", profile_text: "Седемте предоставени основни файла са интегрирани само като проверени SHA-256 отпечатъци и лицензни метаданни. Нативният код и key routines не се пакетират и не се изпълняват.",
      profile_scope: "Обхват", profile_runtime: "Runtime", profile_verification: "Проверка", profile_link: "Отвори валидирания JSON профил",
    ...
    en: {
      ...
      profile_title: "unplayplay metadata profile", profile_text: "The seven supplied root files are integrated only as verified SHA-256 fingerprints and license metadata. Native code and key routines are neither bundled nor executed.",
      profile_scope: "Scope", profile_runtime: "Runtime", profile_verification: "Verification", profile_link: "Open the validated JSON profile",
