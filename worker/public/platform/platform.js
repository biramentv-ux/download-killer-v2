(() => {
  ...
  const I18N = {
    ...
    en: {
      ...
      open_other_domain:"Open the other domain", open_primary_domain:"Open the backup .online domain", mirror_note:"Both addresses use the same database, queue and Telegram integration.",
    ...
    ru: {
      ...
      open_other_domain:"Открыть другой домен", open_primary_domain:"Открыть резервный домен .online", mirror_note:"Оба адреса используют одну базу данных, очередь и Telegram-интеграцию.",
    ...
    de: {
      ...
      open_other_domain:"Andere Domain öffnen", open_primary_domain:"Backup-Domain .online öffnen", mirror_note:"Beide Adressen verwenden dieselbe Datenbank, Warteschlange und Telegram-Integration.",
