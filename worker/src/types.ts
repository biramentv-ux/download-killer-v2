...
export interface Env {
  ...
  TELEGRAM_WEBHOOK_AUTO_CONFIG_ENABLED?: string;
  TELEGRAM_BOT_USERNAME?: string;
  TELEGRAM_DOWNLOAD_CHANNEL_ID?: string;
  TELEGRAM_CHANNEL_PUBLISH_ENABLED?: string;
  TELEGRAM_CHANNEL_FORCE_BOT_DOWNLOADS?: string;
  TELEGRAM_CHANNEL_SEND_AUDIO?: string;
  ...
  SYNC_KEY_EMAIL_REQUIRED?: string;
  SYNC_KEY_TURNSTILE_REQUIRED?: string;
  SYNC_KEY_TURNSTILE_SITE_KEY?: string;
  SYNC_KEY_TURNSTILE_SECRET?: string;
  JOB_RETENTION_ENABLED?: string;
  ...
  RELEASE_RADAR_MAX_CHECKS?: string;
  RELEASE_RADAR_NOTIFY_ENABLED?: string;
